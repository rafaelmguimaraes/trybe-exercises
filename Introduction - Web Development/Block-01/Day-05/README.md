Exercícios propostos na Aula de ShellScript - Módulo 1 Aula 5 - 1_5

Segue abaixo, enunciado dos exercícios:
Exercícios (Solução no arquivo exercise + número da questão)
...
Bônus (Solução no arquivo exercise + número da questão + b)
